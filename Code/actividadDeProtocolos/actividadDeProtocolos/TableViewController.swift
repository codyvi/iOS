...
protocol protocoloChangeColor {
    func changeColor(color : UIColor) -> Void
}


class TableViewController: UITableViewController {
    var listaColores = [UIColor.red, UIColor.green, UIColor.blue, UIColor.yellow, UIColor.purple]
    
    var delegado : protocoloChangeColor!
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        {
            delegado.changeColor(color: color)
